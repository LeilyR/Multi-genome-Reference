...
void Graph::initAllCostScore(all_data data,Graph& newGraph){
	...
	for(size_t i=0 ; i<data.numAlignments(); ++i){
		...
		double m1;
		double m2;
		m.cost_function(data.getAlignment(i),c1,c2,m1,m2);
...
void Graph::parseData(all_data& d, Graph& newGraph){
	...
	// 	std::cout << OV.getSuccessors(oriented); TODO jonas to marion: I have no Idea how this line could compile in your code
